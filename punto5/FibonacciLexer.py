...
def serializedATN():
    return [
        ...
        1,1,1,1,2,1,2,1,2,1,2,1,2,1,3,4,3,22,8,3,11,3,12,3,23,1,4,4,4,27,
        ...
        7,1,0,0,0,0,9,1,0,0,0,1,11,1,0,0,0,3,13,1,0,0,0,5,15,1,0,0,0,7,21,
        1,0,0,0,9,26,1,0,0,0,11,12,5,40,0,0,12,2,1,0,0,0,13,14,5,41,0,0,
        14,4,1,0,0,0,15,16,5,70,0,0,16,17,5,73,0,0,17,18,5,66,0,0,18,19,
        5,79,0,0,19,6,1,0,0,0,20,22,7,0,0,0,21,20,1,0,0,0,22,23,1,0,0,0,
...
class FibonacciLexer(Lexer):
    ...
    ruleNames = [ "T__0", "T__1", "FIBO", "INT", "WS" ]
